...
########################################################################################################################
# Use case #1: Using cyber_physical implementations of System 1 or System 2
#
# Step 1: create a cyber_physical subclass of System 1 and/or System 2 (doesn't have to be a subclass, but must have same interface)
# Step 2: create a MixinDASHAction class (descendant from DASHAction and new System 1(2) impl) that overrides __init__()
# Step 3: create a cyber_physical MyDASHAgent class, add or inherit any customized agent's behavior (attributes and methods here)
########################################################################################################################
...
class MyS1(System1Agent):
    ...
    def __init__(self):
        ...
        # init my cyber_physical attributes here ...

    # implement cyber_physical behavior here ...
...
class MyMixinDASHAction(DASHAction, MyS1):
    def __init__(self):
        ...
        # alternatively it is possible to implement cyber_physical action __init__ if special behavior or init order is needed:
...
########################################################################################################################
# Use case #2: new agent with Discrete Event Simulation (DES) agent with cyber_physical agent_decision_cycle() method.
########################################################################################################################
