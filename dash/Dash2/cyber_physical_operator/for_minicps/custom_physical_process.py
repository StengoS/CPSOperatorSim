...
class RawWaterTank(Tank):
    ...
    def main_loop(self):
        hub_connection = self.connect_to_hub()
        ...
        while(count <= PP_SAMPLES):
            received_req = hub_connection.recv_json()
            print(received_req)
